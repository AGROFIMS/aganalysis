...
#' @param trend logic TRUE if data has trending values (dates), otherwise FALSE
...
#' 
#' @param design character statistical design name
...
#' @param trend logic TRUE if data has trending values (dates), otherwise FALSE
#' @param trend_col character the column name related to the trends \code{(dates)}
#' @description Clean headers, 
#' @importFrom purrr map
#' @importFrom tidyr gather_ separate
