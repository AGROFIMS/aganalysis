...
#' @importFrom shiny reactive tabPanel renderUI selectInput icon h2 uiOutput radioButtons actionButton br column fluidRow fileInput
#' @importFrom shinydashboard infoBox tabBox infoBoxOutput renderInfoBox
#' @importFrom reticulate source_python
#' @importFrom readxl read_excel
#' @importFrom stringr str_detect str_replace_all
#' @importFrom httr upload_file POST content
#' @importFrom stringi stri_rand_strings
#' @importFrom pepa repo.crd repo.f repo.spld repo.rcbd
#' @author Omar Benites
#' @export
