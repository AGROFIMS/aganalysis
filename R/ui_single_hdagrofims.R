                                   ...
                                   tabPanel("", #begin tabset "CHECK"
                                            fluidRow( 
                                              column(width = 8,
                                                     ...
                                                     shiny::fileInput('file_single_agrofims', 'Choose fieldbook file', accept = c(".zip")),  
                                                               
                                                     shinydashboard::infoBoxOutput("file_message_single_agrofims", width = NULL),
                                                     ...
                                                     shiny::selectInput(inputId = 'design_single_agrofims', 
                                                     ...
                                                     shiny::conditionalPanel(
                                                       ...
                                                       shiny::uiOutput("factor_single_agrofims")
                                                     ),
                                                     ...
                                                     shiny::conditionalPanel(
                                                       ...
                                                       shiny::uiOutput("trt_single_agrofims")#,                                                    
                                                     ...
                                                     shiny::conditionalPanel(                                                               
                                                       ...
                                                       shiny::uiOutput("rep_single_agrofims")
                                                     ),  
                                                     ...
                                                     shiny::uiOutput("trait_single_agrofims"),
                                                     ...
                                                     shiny::conditionalPanel(
                                                      ...
                                                      # 
                                                     shiny::downloadButton(outputId = "downloadagrofims_single_report", label = "Download"),
                                                     shiny::downloadLink(outputId = "downloadagrofims_single_rowdata", label = "Download raw data"),
